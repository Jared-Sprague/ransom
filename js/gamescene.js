...
let GameScene = new Phaser.Class({
    ...
    create: function () {
        ...
        // coin particles
        let sparks = this.add.particles('sprites');
        ...
        let expl1 = this.add.particles('sprites');
        ...
        let expl2 = this.add.particles('sprites');
    ...
    playerDies: function () {
        ...
        // add game over text
        let txt = this.add.bitmapText(400, 300, 'fontwhite', 'Game over!');
